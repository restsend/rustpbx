        ...
        match cmd {
            ...
            MediaCommand::Play {
                ...
                let (bridge, endpoint, codec_info) = {
                    ...
                    let fallback = crate::negotiate::CodecInfo {
                        payload_type: 0,
                ...
                let track = crate::FileTrack::new(play_id.clone())
            ...
            MediaCommand::InjectAudio {
                ...
                for ep in &endpoints {
                    ...
                    let t = crate::FileTrack::new(play_id.clone())
...
mod tests {
    ...
    async fn test_attach_detach_bridge() {
        ...
        let bridge = crate::bridge::BridgePeerBuilder::new("test-bridge-1".into())
    ...
    async fn test_inject_audio_produces_play_started() {
        ...
        let bridge = crate::bridge::BridgePeerBuilder::new("test-bridge-inj".into())
    ...
    async fn test_play_file_produces_play_started() {
        ...
        let bridge = crate::bridge::BridgePeerBuilder::new("test-bridge-play".into())
    ...
    async fn test_inject_audio_to_single_leg() {
        ...
        let bridge = crate::bridge::BridgePeerBuilder::new("test-bridge-inj2".into())
    ...
    async fn test_inject_audio_mute_peer() {
        ...
        let bridge = crate::bridge::BridgePeerBuilder::new("test-bridge-inj3".into())
    ...
    async fn test_play_silence_no_event() {
        ...
        let bridge = crate::bridge::BridgePeerBuilder::new("test-bridge-ps".into())
    ...
    async fn test_inject_audio_both_stores_two_track_ids() {
        ...
        let bridge = crate::bridge::BridgePeerBuilder::new("tb-both".into())
            .with_rtp_port_range(28600, 28700)
            .build();
        bridge.setup_bridge().await.unwrap();
    ...
    async fn test_stop_playback_after_inject_both_clears_all_tracks() {
        ...
        let bridge = crate::bridge::BridgePeerBuilder::new("tb-sp-both".into())
    ...
    async fn test_mute_unmute_leg_bridge_output_mode() {
        ...
        let bridge = crate::bridge::BridgePeerBuilder::new("tb-mut".into())
    ...
    async fn test_send_dtmf_with_bridge_injects_packets() {
        ...
        let bridge = crate::bridge::BridgePeerBuilder::new("tb-dtmf".into())
        ...
        let result = bridge
            .send_dtmf_to_endpoint(crate::bridge::BridgeEndpoint::Callee, "5#")
            .await;
        assert!(
            result.is_ok(),
    ...
    async fn test_send_dtmf_unknown_digit_error() {
        let bridge = crate::bridge::BridgePeerBuilder::new("tb-dtmf-err".into())
            .with_rtp_port_range(29000, 29100)
            .build();
        bridge.setup_bridge().await.unwrap();

        let result = bridge
            .send_dtmf_to_endpoint(crate::bridge::BridgeEndpoint::Caller, "X")
            .await;
        assert!(
            result.is_err(),
