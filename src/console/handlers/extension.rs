...
struct ExtensionSummary {
    ...
    status: &'static str,
    login_allowed: bool,
    call_forwarding_mode: &'static str,
    call_forwarding_destination: Option<&'static str>,
...
fn sample_extension_summaries() -> Vec<ExtensionSummary> {
    vec![
        ExtensionSummary {
            ...
            call_forwarding_destination: Some("sip:1002@example.com"),
        ...
        ExtensionSummary {
            ...
            status: "Idle",
            login_allowed: true,
            call_forwarding_mode: "when_busy",
            call_forwarding_destination: Some("+1 555 010 0300"),
        ...
        ExtensionSummary {
            ...
            login_allowed: true,
            call_forwarding_mode: "always",
            call_forwarding_destination: Some("voicemail:1005"),
    ...
    let extensions: Vec<_> = list
        ...
        .map(|item| {
            ...
            json!({
                ...
                "call_forwarding_mode": item.call_forwarding_mode,
                "call_forwarding_destination": item.call_forwarding_destination,
